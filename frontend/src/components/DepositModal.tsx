...
export default function DepositModal({ onClose, onSubmit }: DepositModalProps) {
      ...
      <div className="space-y-4">
        ...
        <div className="p-3 rounded-lg bg-accent-dim border border-accent/20 text-xs text-muted space-y-1">
          <div className="flex justify-between">
            <span>Action</span>
            <span className="text-foreground">Lock tokens + encrypt balance</span>
          </div>
          <div className="flex justify-between">
            <span>Privacy</span>
            <span className="text-accent">Amount hidden after deposit</span>
          </div>
        </div>
